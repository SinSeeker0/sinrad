...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  offlineAuthStatus: () => ipcRenderer.invoke("offline-auth-status"),
  offlineRedditConnect: (input) => ipcRenderer.invoke("offline-reddit-connect", input),
  offlineRedditDisconnect: () => ipcRenderer.invoke("offline-reddit-disconnect"),
